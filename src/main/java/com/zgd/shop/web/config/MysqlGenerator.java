...
public class MysqlGenerator {
  ...
  public static void main(String[] args) {
    ...
    String outputPath = projectPath +"/"+rs.getString("moduleName")+ "/src/main/java";
    if (rs.containsKey("outputDir")){
      String outputDir = rs.getString("outputDir");
      outputPath = StringUtils.isNoneBlank(outputDir) ? outputDir : outputPath;
    }
...
//    dsc.setSchemaname(rs.getString("databaseName"));
...
//    pc.setModuleName(rs.getString("moduleName"));
